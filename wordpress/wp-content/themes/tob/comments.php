...
<h3 class="comments-title" id="comments">
	<?php echo _hui('comment_title', '评论') ?><small><?php echo $count_t ? $count_t : '抢沙发'; ?></small>
</h3>
<div id="respond" class="comments-respond no_webshot">
	...
	<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
		<div class="comt">
			...
			<div class="comt-box">
				<textarea placeholder="<?php echo _hui('comment_text') ?>" class="comt-area" name="comment" id="comment" cols="100%" rows="3" tabindex="1" onkeydown="if(event.ctrlKey&amp;&amp;event.keyCode==13){document.getElementById('submit').click();return false};"></textarea>
				<div class="comt-ctrl">
					<div class="comt-tips"><?php comment_id_fields(); do_action('comment_form', $post->ID); ?></div>
					<button class="comt-submit" type="submit" name="submit" id="submit" tabindex="5"><?php echo _hui('comment_submit_text', '提交评论') ?></button>
				</div>
			</div>
