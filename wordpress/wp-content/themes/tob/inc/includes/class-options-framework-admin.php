...
class Options_Framework_Admin {
	...
	static function menu_settings() {
		...
		$menu = array(
            ...
            'page_title' => __( 'tob主题设置', 'theme-textdomain' ),
			'menu_title' => __( 'tob主题设置', 'theme-textdomain' ),
	    ...
	    <div id="optionsframework-metabox" class="metabox-holder">
		    <div id="optionsframework" class="postbox">
				...
				<div class="optionsframework-side">
					<a href="http://themebetter.com" target="_blank"><img src="http://themebetter.com/tm/VPvGbq/opad"></a>
				</div>
			</div> <!-- / #container -->
		</div>
